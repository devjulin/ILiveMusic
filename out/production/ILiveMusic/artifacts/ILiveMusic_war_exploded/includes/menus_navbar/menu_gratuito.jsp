        ...
        <div class="w3-container">
            <div class=" w-75">
                ...
                <div class=" d-flex mx-auto" style="width: 132%;">
                    ...
                    <a class=" fw-bold text-decoration-none permissao-premium" id="seja-premium" href="assinatura.jsp">SEJA
                        PREMIUM</a>
                    ...
                    <ul class=" p-3 dropdown-menu bg-secondary" aria-labelledby="profileDropdown">
                        ...
                        <li>
                            ...
                            <div class="text-dark fw-bold  mx-2 text-center" style="font-size: 80%">Usuario: <a
                                    class="text-white permissao-gratuito text-decoration-none">Comum</a></div>
                        </li>
                    </ul>
