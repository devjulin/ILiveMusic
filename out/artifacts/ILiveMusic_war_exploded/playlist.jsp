...
<html>
    <head>
        ...
        <title>Playlist - ${playlistSelecionada.nome_playlist}</title>
    ...
    <style>
        * {
        ...
        #album-art.active {
            top: -60px;
            box-shadow: 0 0 0 4px purple, 0 30px 50px -15px #afb7c1;
        }
    ...
    <body class="modo-claro mx-auto">
            ...
            <div class="row fixo reaj_album ">
                <div class="linha-superior">
                    <div class="col-5">
                        ...
                        <div class="album">
                            <img class="playlist_img" id="capa_playlist" src="${pageContext.request.contextPath}/${playlistSelecionada.caminho_imagem}" alt="Img_Playlist">
                        </div>
                    </div>
                    <div class="col-8 w-100">
                        <h5 class="tag-playlist">Playlist</h5>
                        <h2 class=" titulo-playlist fw-bold">${playlistSelecionada.nome_playlist}</h2>
                    </div>
        ...
        <div class="container-fluid inferior mt-5 reaj-player">
            ...
            <script>
                // Carrega a imagem
                var image = new Image();
                image.src = '${playlistSelecionada.caminho_imagem}';

                // Aguarda o carregamento completo da imagem
                image.onload = function () {
                    // Cria uma instância do ColorThief
                    var colorThief = new ColorThief();

                    // Obtém a paleta de cores da imagem
                    var palette = colorThief.getPalette(image, 2); // Obtém as 2 primeiras cores principais da paleta

                    // Constrói o degradê CSS com base na paleta de cores
                    ...
                    for (var i = 0; i < palette.length; i++) {
                        ...
                        // Ajusta o espaço da primeira cor no degradê
                        if (i === 0) {
                            gradient += ', ' + hexColor + ' 0%, ' + hexColor + ' 30%';
                        } else {
                            gradient += ', ' + hexColor;
                        }
                    }

                    gradient += ', black)'; // Adiciona a cor preta como a última etapa do degradê

                    // Aplica o degradê como estilo do elemento .fundo-superior
                    var fundoSuperior = document.querySelector('.fundo-superior');
                    fundoSuperior.style.background = gradient;
                };

                // Função para converter RGB em formato hexadecimal
                ...
                $(function () {
                    var playerTrack = $("#player-track"),
                            ...
                            trackNames = [
                                ...
                                "Why We Lose (feat. Coleman Trapp) [NCS Release]",
                                "Cradles [NCS Release]",
                            ...
                            trackUrl = [
                                "musica/artista/ncs/Cartoon - On & On (feat. Daniel Levi) [NCS Release].mp3",
                                "musica/artista/ncs/Cartoon - Why We Lose (feat. Coleman Trapp) [NCS Release].mp3",
                                "musica/artista/ncs/Cradles [NCS Release].mp3",
                                "musica/artista/ncs/DEAF KEV - Invincible [NCS Release].mp3",
                                "musica/artista/ncs/Diviners - Savannah (feat. Philly K) [NCS Release].mp3",
                                "musica/artista/ncs/Janji - Heroes Tonight (feat. Johnning) [NCS Release].mp3",
                                "musica/artista/ncs/Jo Cohen & Sex Whales - We Are [NCS Release].mp3",
                                "musica/artista/ncs/Ship Wrek & Zookeepers - Ark [NCS Release].mp3",
                                "musica/artista/ncs/Syn Cole - Feel Good [NCS Release].mp3"
                            ],
