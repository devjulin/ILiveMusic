...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left text-white fw-bold bg-menulateral-aberto"
    ...
    <a href="#" class="menulateral txt-branco w3-bar-item w3-button bi bi-house" data-bs-toggle="modal"
    ...
    <a href="cadastro_usuario.jsp" class="menulateral txt-branco w3-bar-item w3-button bi bi bi-person-badge"> |
        Cadastrar Conta</a>
    <a href="testando.jsp" class="menulateral txt-branco w3-bar-item w3-button bi bi-house"> | testando</a>
</div>
