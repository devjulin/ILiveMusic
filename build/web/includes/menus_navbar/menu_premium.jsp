        ...
        <div class="w3-container">
            <div class=" w-75">
                ...
                <div class=" d-flex mx-auto" style="width: 132%;">
                    ...
                    <a class=" fw-bold text-decoration-none permissao-premium"
                       id="seja-premium">PREMIUM: ${diasRestantes} Dias Restantes</a>
                    ...
                    <ul class=" p-3 dropdown-menu bg-secondary" aria-labelledby="profileDropdown">
                        ...
                        <li>
                            <!-- <a class="dropdown-item text-warning text-center fs-8 fw-bold" href="painel_premium.jsp">Painel PREMIUM</a>-->
                            ...
                            <div class="marquee">
                                <span class="fw-bold text-white">Bem Vindo: ${usuario.nome}</span>
                            </div>
                            <div class="text-dark fw-bold  mx-2 text-center" style="font-size: 80%">Usuario: <a
                                    class="  fs-5 permissao-premium text-decoration-none">PREMIUM</a></div>
                        </li>
                    </ul>
