    ...
    <style>
        * {
        ...
        .fundo-superior {
            ...
            z-index: -1;
            position: absolute;
            background: linear-gradient(to bottom, rgba(255, 0, 147, 1), rgba(88, 0, 151, 0.7), rgba(0, 0, 0, 0.1));
        }
                        ...
                        <tr class="album pointer" data-switch="1">
                            <td data-label="Título">
                                <div class="text-start w-75" style="display: inline-block; text-align: left;">
                                    ...
                                    Why We Lose (feat. Coleman Trapp)
                                </div>
                            </td>
                            <td>NCS - Release</td>
                            <td class="reaj-res-menor">13/06/2023</td>
                        ...
                        <tr class="album pointer" data-switch="7">
                            <td data-label="Título">
                                <div class="text-start w-75" style="display: inline-block; text-align: left;">
                                    ...
                                    <span class="title-text">Cartoon - On & On (feat. Daniel Levi)</span>
                                </div>
                            </td>
                            <td>NCS - Release</td>
                            <td class="reaj-res-menor">13/06/2023</td>
